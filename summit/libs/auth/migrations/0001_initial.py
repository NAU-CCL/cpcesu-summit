    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('view_profile', 'Can see user profiles'),),
            },
        ),
        migrations.CreateModel(
            name='CESUnit',
        ...
        migrations.AddField(
            model_name='user',
            name='group',
            field=models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='summit_auth.UserGroup'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
