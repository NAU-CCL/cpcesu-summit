...
def collect_data(filename):
    ...
    with Img(filename=filename, resolution=300) as img:
        ...
        # Non-options
        pictures = ['title', 'agreement_number', 'supplement_number', 'supplement_number', 'effective_date',
    ...
    os.remove('test-1.png')
    os.remove('test-2.png')
    os.remove('test-3.png')

    print(pdf_field_text)
