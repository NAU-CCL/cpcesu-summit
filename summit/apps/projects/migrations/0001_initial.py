    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Initial funding amount (USD)', max_digits=12, null=True, verbose_name='Initial')),
                ...
                ('youth_vets', models.CharField(blank=True, choices=[('IMRO', 'IMRO'), ('WASO', 'WASO'), ('AKRO', 'AKRO'), ('MWRO', 'MWRO'), ('NERO', 'NERO'), ('NCRO', 'NCRO'), ('PWRO', 'PWRO'), ('SERO', 'SERO')], max_length=500, null=True)),
