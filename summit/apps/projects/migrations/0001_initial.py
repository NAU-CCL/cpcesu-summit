    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod_approved', models.DateField(blank=True, default='2019-1-1', verbose_name='Approved)')),
                ('mod_executed', models.DateField(blank=True, default='2019-1-1', verbose_name='Executed')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('budget', models.DecimalField(blank=True, decimal_places=2, help_text='Initial funding amount (USD)', max_digits=12, null=True, verbose_name='Initial')),
                ...
                ('discipline', models.CharField(blank=True, choices=[('NONE', 'None'), ('NATURAL', 'Natural'), ('CULTURAL', 'Cultural'), ('SOCIAL', 'Social'), ('INTERDISCIPLINARY', 'Interdisciplinary')], default=('NONE', 'None'), help_text='The discipline related to the project', max_length=20)),
                ...
                ('init_start_date', models.DateField(blank=True, default='2019-1-1', verbose_name='Project Initially Received')),
                ...
                ('status', models.CharField(blank=True, choices=[('DRAFT', 'Drafting'), ('EXECUTED', 'Executed'), ('CLOSED', 'Closed')], default=('DRAFT', 'Drafting'), max_length=20)),
                ('tent_end_date', models.DateField(blank=True, default='2019-1-1', verbose_name='Tentative End Date')),
                ('tent_start_date', models.DateField(blank=True, default='2019-1-1', verbose_name='Tentative Start Date')),
                ...
                ('vet_support', models.CharField(blank=True, choices=[('NONE', 'None'), ('YOUTH', 'Youth/Young Adults'), ('VETS', 'Veterans'), ('BOTH', 'Youth/Young Adults and Veterans')], default=('NONE', 'None'), max_length=5, verbose_name='Youth/Veteran')),
                ...
                ('task_agreement_start_date', models.DateField(blank=True, default='2019-1-1', verbose_name='Approved')),
                ...
                ('cesu_unit', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cesu_unit', to='summit_auth.CESUnit', verbose_name='CESUnit')),
                ...
                ('partner', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partner', to='summit_auth.Partner')),
                ('pp_i', models.ForeignKey(blank=True, default=None, help_text='Partner Principle Investigator', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pp_i', to='summit_auth.UserProfile', verbose_name='Partner Principle Investigator')),
                ('project_manager', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_manager', to='summit_auth.UserProfile', verbose_name='Agency Project Manager')),
                ('staff_member', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='staff_member', to='summit_auth.UserProfile', verbose_name='Staff Member')),
                ('tech_rep', models.ForeignKey(blank=True, help_text='Agreements Tech Representative if Partner:NPS is selected', null=True, on_delete=django.db.models.deletion.CASCADE, to='summit_auth.UserProfile', verbose_name='Agreements Tech Representative')),
            ],
            options={
                'abstract': False,
            },
